...
public class MainActivity extends Activity {
	...
	private Button btnMulPreScreen;
	private Button btnPreFragment;
	...
	private void initView() {
		...
		btnMulPreScreen=(Button) findViewById(R.id.btn_mul_pre_screen);
		btnPreFragment=(Button) findViewById(R.id.btn_pre_fragment);
		btnSetting.setOnClickListener(buttonListener);
		btnShow.setOnClickListener(buttonListener);
		btnMulPreScreen.setOnClickListener(buttonListener);
		btnPreFragment.setOnClickListener(buttonListener);
	...
	private OnClickListener buttonListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.btn_show:
				showSettingInfo();
				break;
			case R.id.btn_mul_pre_screen:
				startActivity(new Intent(MainActivity.this,MulPreScreen.class));
				break;
			case R.id.btn_pre_fragment:
